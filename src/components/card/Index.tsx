...
export const Card = ({ image, title, description, color }: CardProps) => {
    return (
        <div className={`${color == 'WHITE' ? 'bg-white text-dark' : 'bg-primary text-white'} flex flex-col gap-4 m-1 sm:m-4 rounded-xl text-start md:text-center py-12 px-4 items-center border shadow-md`}>
